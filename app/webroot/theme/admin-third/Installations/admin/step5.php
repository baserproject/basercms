...
<div class="step-5">
	...
	<div class="em-box bca-em-box"> <?php echo __d('baser', 'おめでとうございます！baserCMSのインストールが無事完了しました！ <br />管理用メールアドレスへインストール完了メールを送信しています。')?></div>
	...
	<div class="panel-box bca-panel-box corner10">
		<div class="section">
			<ul>
				...
				<li><a href="http://wiki.basercms.net" title="baserCMS公式ガイド" target="_blank" class="outside-link"><?php echo __d('baser', 'baserCMS公式ガイドで学ぶ')?></a></li>
