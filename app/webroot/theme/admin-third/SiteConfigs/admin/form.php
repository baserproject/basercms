...
<?php echo $this->BcForm->hidden('SiteConfig.id') ?>
  ...
  <table cellpadding="0" cellspacing="0" class="form-table bca-form-table section" data-bca-table-type="type2">
    ...
    <tr>
      <th class="col-head bca-form-table__label"><?php echo $this->BcForm->label('SiteConfig.email', __d('baser', '管理者メールアドレス')) ?>&nbsp;<span class="required bca-label" data-bca-label-type="required"><?php echo __d('baser', '必須') ?></span></th>
      <td class="col-input bca-form-table__input">
    ...
    <tr>
      ...
      <td class="col-input bca-form-table__input">
        ...
        <div id="helptextSiteUrl" class="helptext"><?php echo __d('baser', 'baserCMSを設置しているURLを指定します。管理画面等でSSL通信を利用する場合は、SSL通信で利用するURLも指定します。') ?></div>
      </td>
    </tr>
    <tr>
      ...
      <td class="col-input bca-form-table__input">
        ...
        <i class="bca-icon--question-circle btn help bca-help"></i>
        <div id="helptextMaintenance" class="helptext"><?php echo __d('baser', '公開状態を指定します。<br>メンテナンス中の場合に、公開ページを確認するには、管理画面にログインする必要があります。<br>ただし、制作・開発モードがデバッグモードに設定されている場合は、メンテナンス中にしていても公開ページが表示されてしまいますので注意が必要です。')?></div>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="col-input bca-form-table__input">
        ...
        <i class="bca-icon--question-circle btn help bca-help"></i>
        <div id="helptextWidgetArea" class="helptext"><?php echo sprintf(__d('baser', 'ウィジェットエリアは「%s」より追加できます。'), $this->BcBaser->getLink(__d('baser', 'ウィジェットエリア管理'), ['controller' => 'widget_areas', 'action' => 'index']))?></div>
      </td>
    </tr>
  </table>
</section>
	  ...
	  <table cellpadding="0" cellspacing="0" class="form-table bca-form-table section" data-bca-table-type="type2">
		...
		<tr>
		  ...
		  <td class="col-input bca-form-table__input">
			...
			<i class="bca-icon--question-circle btn help bca-help"></i>
			<div id="helptextAdminListNum" class="helptext"><?php echo __d('baser', 'ダッシュボードに表示される「最近の動き」などの表示件数を設定します') ?></div>
		  </td>
		</tr>
		<tr>
  ...
  <table cellpadding="0" cellspacing="0" class="form-table bca-form-table section" data-bca-table-type="type2">
    ...
    <tr>
      ...
      <td class="col-input bca-form-table__input">
        ...
        <i class="bca-icon--question-circle btn help bca-help"></i>
        <div class="helptext"><?php echo __d('baser', 'サブサイトにデバイス属性を持たせ、サイトアクセス時、ユーザーエージェントを判定し適切なサイトを表示する機能を利用します。') ?></div>
        <br>
	...
	<table cellpadding="0" cellspacing="0" class="form-table bca-form-table" data-bca-table-type="type2">
		<tr>
			...
			<td class="col-input bca-form-table__input">
				...
				<i class="bca-icon--question-circle btn help bca-help"></i>
				<div id="helptextEncode" class="helptext"><?php echo __d('baser', '送信メールの文字コードを選択します。<br>受信したメールが文字化けする場合に変更します。')?></div>
        ...
        <table class="bca-form-table__inner-table">
          <tr>
            ...
            <td class="bca-form-table__inner-table-input">
              ...
              <i class="bca-icon--question-circle btn help bca-help"></i>
              <div id="helptextSmtpHost" class="helptext"><?php echo __d('baser', 'メールの送信にSMTPサーバーを利用する場合指定します。') ?></div>
            </td>
          </tr>
          <tr class="bca-form-table__inner-table-label">
            ...
            <td class="bca-form-table__inner-table-input">
              ...
              <i class="bca-icon--question-circle btn help bca-help"></i>
              <div class="helptext"><?php echo __d('baser', 'メールの送信にSMTPサーバーを利用する場合指定します。入力を省略した場合、25番ポートを利用します。') ?></div>
            </td>
          </tr>
          <tr>
            <th class="bca-form-table__inner-table-label">
            ...
            <td class="bca-form-table__inner-table-input">
              ...
              <i class="bca-icon--question-circle btn help bca-help"></i>
              <div id="helptextSmtpUsername" class="helptext"><?php echo __d('baser', 'メールの送信にSMTPサーバーを利用する場合指定します。') ?></div>
            </td>
          </tr>
          <tr>
            <th class="bca-form-table__inner-table-label">
            ...
            <td class="bca-form-table__inner-table-input">
              ...
              <i class="bca-icon--question-circle btn help bca-help"></i>
              <div id="helptextSmtpPassword" class="helptext"><?php echo __d('baser', 'メールの送信にSMTPサーバーを利用する場合指定します。') ?></div>
            </td>
          </tr>
          <tr>
            <th class="bca-form-table__inner-table-label">
            ...
            <td class="bca-form-table__inner-table-input">
              ...
              <i class="bca-icon--question-circle btn help bca-help"></i>
              <div id="helptextSmtpTls" class="helptext"><?php echo __d('baser', 'SMTPサーバーがTLS暗号化を利用する場合指定します。') ?></div>
            </td>
          </tr>
        </table>
