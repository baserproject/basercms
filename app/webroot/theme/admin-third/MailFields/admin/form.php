				...
				<td class="col-input bca-form-table__input">
					...
					<div id="helptextValidEx" class="helptext">
						<ul>
							...
							<li><?php echo __d('baser', 'ファイル拡張子チェック：利用するには、「ファイル」タイプを選択し、オプション項目に、アップロードを許可する拡張子を次の形式のように | 区切りで入力します。「fileExt|jpg,pdf」<br>未設定の場合は「gif,jpg,jpeg,png,pdf」を許可します。') ?></li>
