...
<section id="EtcSetting" class="bca-section" data-bca-section-type="form-group">
  ...
  <div class="bca-collapse" id="formContentsInfoBody" data-bca-state="">
    ...
    <ul class="bca-list" data-bca-list-layout="horizon" data-bca-list-type='circle'>
      <li class="bca-list__item"><span><?php echo __d('baser', 'コンテンツID') ?></span>：<?php echo $this->request->data['Content']['id'] ?></li>
      <li class="bca-list__item"><span><?php echo __d('baser', '実体ID') ?></span>：<?php echo $this->request->data['Content']['entity_id'] ?></li>
      <li class="bca-list__item"><span><?php echo __d('baser', 'プラグイン') ?></span>：<?php echo $this->request->data['Content']['plugin'] ?></li>
      ...
      <li class="bca-list__item"><span><?php echo __d('baser', 'サイト') ?></span>：<?php echo h($this->BcText->noValue($this->request->data['Site']['display_name'], $mainSiteDisplayName)) ?></li>
