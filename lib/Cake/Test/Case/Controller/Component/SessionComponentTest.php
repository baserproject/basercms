 ...
 */
	public function testSessionFlash() {
		...
		$this->assertEquals(['message' => 'This is a test message', 'element' => 'default', 'params' => []], $Session->read('Message.flash'));

		$Session->setFlash('This is a test message', 'test', ['name' => 'Joel Moss']);
		$this->assertEquals(['message' => 'This is a test message', 'element' => 'test', 'params' => ['name' => 'Joel Moss']], $Session->read('Message.flash'));

		$Session->setFlash('This is a test message', 'default', [], 'myFlash');
		$this->assertEquals(['message' => 'This is a test message', 'element' => 'default', 'params' => []], $Session->read('Message.myFlash'));
