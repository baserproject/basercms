...
App::uses('SearchIndicesController', 'Controller');

/**
 * SearchIndicesControllerTest class
 *
 * @package Baser.Test.Case.Controller
 ...
 * [AJAX] 優先順位を変更する
 */
	public function testAdmin_ajax_change_priority() {
		$this->markTestIncomplete('このテストは、まだ実装されていません。');
	}
 ...
 * 検索インデックスを再構築する
 */
	public function testAdmin_reconstruct() {
		$this->markTestIncomplete('このテストは、まだ実装されていません。');
	}
