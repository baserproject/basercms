...
/**
 * UserGroupsControllerTest class
 *
 * @package Baser.Test.Case.Controller
 * @property  UserGroupsController $UserGroupsController
 */
class UserGroupsControllerTest extends BaserTestCase {
 ...
 */
	public function testAdmin_set_default_favorites() {
		$this->markTestIncomplete('このテストは、まだ実装されていません。');
	}
