 ...
 */
	 ...
	 * @return string
	 */
	public function getFileUploadErrorMessage($code, $errorMessage = '') {
		if (!$code) {
			return '';
		}
		...
		switch ($code) {
			case 1:
				...
				$message = 'ファイルサイズがアップロード可能なサイズをオーバーしています。';
				break;
			case 2:
				...
				if ($errorMessage) {
					...
					$message = 'ファイルサイズがHTMLで指定された MAX_FILE_SIZE をオーバーしています。';
				}
				break;
			case 3:
				// UPLOAD_ERR_PARTIAL
