 ...
 */
	public function available() {
		...
		if (empty($testCases)) {
			$this->out(__d('baser_console', "有効なテストケースがありません。 \n\n"));
		...
		while ($choice = $this->in(__d('baser_console', '何のテストケースを実行したいですか？'), null, 'q')) {
 ...
 */
	public function main() {
		...
		// ---
		$this->out(__d('baser_console', 'baserCMS テストシェル'));
		// <<<
 ...
 */
	protected function _welcome() {
		...
		// ---
		$this->out(__d('baser_console', '<info>baserCMS %s コンソールへようこそ</info>', 'v' . getVersion()));
		// <<<
