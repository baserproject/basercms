...
<?php endif ?>
	...
	<table cellpadding="0" cellspacing="0" class="form-table">
		<tr>
			<th><?php echo $this->BcForm->label('SiteConfig.mail_encode', 'メール送信文字コード') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
				<?php echo $this->BcForm->input('SiteConfig.mail_encode', array('type' => 'text', 'size' => 35, 'maxlength' => 255)) ?>
...
<div class="submit">
	<?php echo $this->BcForm->submit('更新', array('div' => false, 'class' => 'btn-orange button', 'id' => 'btnSubmit')) ?>
</div>
