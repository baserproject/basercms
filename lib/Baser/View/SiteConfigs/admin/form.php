	...
	<table cellpadding="0" cellspacing="0" class="form-table">
		...
		<tr>
			...
			<td class="col-input">
				...
				ユニバーサルアナリティクスを <?php echo $this->BcForm->input('SiteConfig.use_universal_analytics', ['type' => 'radio', 'options' => ['0' => __d('baser', '利用していない'), '1' => __d('baser', '利用している')]]) ?>
			</td>
		</tr>
		<tr>
			...
			<td class="col-input">
				...
				<div id="helptextWidgetArea" class="helptext">
					...
					ウィジェットエリアは「<?php $this->BcBaser->link(__d('baser', 'ウィジェットエリア管理'), ['controller' => 'widget_areas', 'action' => 'index']) ?>」より追加できます。
				</div>
			</td>
		</tr>
		<tr>
