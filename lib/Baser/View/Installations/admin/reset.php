...
<?php if (!$complete): ?>
	...
	<?php if (BC_INSTALLED): ?>
		...
		<ul><li><?php $this->BcBaser->link('バックアップはこちらから', ['admin' => true, 'controller' => 'tools', 'action' => 'maintenance', 'backup', '?' => ['backup_encoding' => 'UTF-8']]) ?></li></ul>
	<?php endif ?>
	...
	<?php echo $this->BcForm->end(['label' => '初期化する', 'class' => 'button']) ?>
...
<?php else: ?>
	...
	<div class="submit">
		<?php $this->BcBaser->link('インストールページへ', '/', ['class' => 'button btn-red']) ?>
	</div>
<?php endif ?>