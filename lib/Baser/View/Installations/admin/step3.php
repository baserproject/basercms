...
$this->BcBaser->i18nScript([
	'message1' => __d('データベースのホスト名を入力してください。'),
	'message2' => __d('データベースユーザー名を入力してください。'),
	'message3' => __d('データベース名を入力してください。'),
	'message4' => __d('他のアプリケーションと重複しないプレフィックスを入力してください。（例）mysite_'),
	'message5' => __d('プレフィックスの末尾はアンダースコアにしてください。（例）mysite_'),
	'message6' => __d('プレフィックスは英数字とアンダースコアの組み合わせにしてください。（例）mysite_'),
	'message7' => __d('ドット（.）を含むデータベース名にはインストールできません。'),
	'message8' => __d('データベースのポートナンバーを入力してください。')
]);
?>
...
<div class="step-3">
	...
	<div class="em-box">
<?php echo __d('baser', 'データベースサーバーの場合は、データベースの接続情報を入力し接続テストを実行してください。<br>
		...
		<div class="section">
			...
			<ul>
				...
				<li id="dbInfo" class="clearfix">
					...
					<small>※ <?php echo __d('baser', 'プレフィックスは英数字とアンダースコアの組み合わせとし末尾はアンダースコアにしてください。<br />
