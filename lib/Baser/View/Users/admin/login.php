...
<div id="Login">
	...
	<div id="LoginInner">
		...
		<div class="float-left submit">
			<?php echo $this->BcForm->submit('ログイン', ['div' => false, 'class' => 'btn-red button', 'id' => 'BtnLogin', 'tabindex' => 4]) ?>
		</div>
		<div class="clear login-etc">
			<?php echo $this->BcForm->input($userModel . '.saved', ['type' => 'checkbox', 'label' => 'ログイン状態を保存する', 'tabindex' => 3]) ?>　
			<?php if ($currentPrefix == 'front'): ?>
				<?php $this->BcBaser->link('パスワードを忘れた場合はこちら', ['action' => 'reset_password'], ['rel' => 'popup']) ?>
			<?php else: ?>
				<?php $this->BcBaser->link('パスワードを忘れた場合はこちら', ['action' => 'reset_password', $this->request->params['prefix'] => true], ['rel' => 'popup']) ?>
			<?php endif ?>
		</div>
