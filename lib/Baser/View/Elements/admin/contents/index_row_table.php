...
<tr id="Row<?php echo $count + 1 ?>" <?php echo $class; ?>>
	<td class="row-tools" style="width:20%">
		...
		<?php if(!$manageDisabled && !empty($this->BcContents->settings[$type]['routes']['manage'])): ?>
			<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icon_manage.png', ['width' => 32, 'height' => 32, 'alt' => '管理', 'class' => 'btn']), array_merge($this->BcContents->settings[$type]['routes']['manage'], $urlParams), ['title' => '管理', 'class' => 'btn-manage']) ?>
		<?php endif ?>
		...
		<?php if(!$editDisabled && $type != 'ContentFolder' && !empty($this->BcContents->settings[$type]['routes']['copy'])): ?>
			<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icon_copy.png', ['width' => 32, 'height' => 32, 'alt' => 'コピー', 'class' => 'btn']), array_merge($this->BcContents->settings[$type]['routes']['copy'], $urlParams), ['title' => 'コピー', 'class' => 'btn-copy']) ?>
		<?php endif ?>
		<?php if(!$editDisabled): ?>
			<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icon_edit.png', ['width' => 32, 'height' => 32, 'alt' => '編集', 'class' => 'btn']), array_merge($this->BcContents->settings[$type]['routes']['edit'], $urlParams), ['title' => '編集', 'class' => 'btn-edit']) ?>
		<?php endif ?>
