...
<?php endif ?>
	...
	<?php if($data['type'] == 'image'): ?>
		<?php $this->BcBaser->link(
				$this->BcBaser->getImg(array_merge(array('action' => 'img_thumb', 100, 100, $theme, $plugin, $type), $params), array('alt'=>$data['name'])),
				array_merge(array('action' => 'img', $theme, $plugin, $type), explode('/', $path), array($data['name'])),
