		...
		<ul class="cleafix">
			...
			<li>
				<?php $this->BcBaser->link(__d('baser', 'テーマ用初期データダウンロード'), ['plugin' => null, 'controller' => 'themes', 'action' => 'download_default_data_pattern'], [],
					...
					__d('baser', 'ダウンロードしたデータは、配布用テーマの Config/data/ 内に配置してください。')) ?>
			</li>
			<li>
				...
				__d('baser', '※ 初期データを読み込むと現在登録されている記事データや設定は全て上書きされますのでご注意ください。\n') .
                __d('baser', '※ 管理ログは読み込まれず、ユーザー情報はログインしているユーザーのみに初期化されます。')) ?>
			</li>
