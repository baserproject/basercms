...
<tr>
	...
	<td>
		<ul class="cleafix">
			<li><?php $this->BcBaser->link('サーバーキャッシュ削除', array('controller' => 'site_configs', 'action' => 'del_cache', 'plugin' => null), array('class' => 'submit-token', 'confirm' => 'サーバーキャッシュを削除します。いいですか？')) ?></li>
