...
<div id="Footer">
	...
	<div id="FooterInner" class="clearfix">
		...
		<div class="float-right">
			<ul id="FooterBanner">
				<li><?php $this->BcBaser->link($this->BcBaser->getImg('baser.power.gif', ['alt' => 'baserCMS Power']), 'http://basercms.net/', ['target' => '_blank', 'title' => 'baserCMS Power']) ?></li>
				<li><?php $this->BcBaser->link($this->BcBaser->getImg('cake.power.gif', ['alt' => 'CakePHP Power']), 'http://cakephp.jp/', ['target' => '_blank', 'title' => 'CakePHP Power']) ?></li>
			</ul>
