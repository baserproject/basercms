...
<tr<?php $this->BcListTable->rowClass(true, $data) ?>>
	<td class="row-tools">
		<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_edit.png', ['alt' => '編集', 'class' => 'btn']), ['action' => 'edit', $data['EditorTemplate']['id']], ['title' => '編集']) ?>
		<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_delete.png', ['alt' => '削除', 'class' => 'btn']), ['action' => 'ajax_delete', $data['EditorTemplate']['id']], ['title' => '削除', 'class' => 'btn-delete']) ?>
	</td>
