...
<ul>
	...
	<li><?php echo sprintf(__d('baser', '新しいコンテンツを登録するには、ツリー形式で、フォルダの名称の右側に配置された機能ボタン %s をクリックするか、フォルダを指定してサブメニューの「コンテンツ新規追加」をクリックし機能メニューを表示します。'), $this->BcBaser->img('admin/icon_function.png'))?></li>
	<li><?php echo __d('baser', '機能メニューでは、各コンテンツ追加できる他、指定したコンテンツについて、公開・非公開切り替え、名称変更、編集画面への遷移、コピー、ゴミ箱に入れる等の機能が提供されています。')?></li>
	<li><?php echo __d('baser', 'ツリー構造において、構成、並び順は、フロントエンド側のメニューに連携します。並び順や、フォルダを変更する場合は、対象コンテンツのアイコンを指定し、ドラッグ＆ドロップで移動する事ができます。<br>
