...
<ul>
	<li><?php echo __d('baser', 'Baserコア・・・/baser/config/sql/') ?></li>
	<li><?php echo __d('baser', 'プラグイン・・・/{プラグインフォルダ}/config/sql/') ?></li>
</ul>

<p><?php echo __d('baser', 'アップデート時に利用するファイルは、次のフォルダ内に配置します。') ?></p>
<ul>
	<li><?php echo __d('baser', 'Baserコア・・・/baser/config/update/{バージョン番号}/sql/') ?></li>
	<li><?php echo __d('baser', 'プラグイン・・・/{プラグインフォルダ}/config/update/{バージョン番号}/sql/') ?></li>
</ul>
