...
<p><?php echo sprintf(__d('baser', 'システム管理グループのユーザーでログインしている場合、一覧の%sより簡単に他のユーザーとして再ログインする事ができます（代理ログイン）。<br />他のユーザーの「よく使う項目」を登録する場合などに便利です。'), $this->BcBaser->img('admin/icn_tool_login.png', ['alt' => __d('baser', 'ログイン'), 'title' => __d('baser', 'ログイン')]))?></p>
