 ...
 * ブラウザ判別用
 *
 * TODO: グローバル汚染 credit.js で使用中
 */
var _ua = (function () {
  return {
    ltIE6: typeof addEventListener === 'undefined' && typeof document.documentElement.style.maxHeight === 'undefined',
    ltIE7: typeof addEventListener === 'undefined' && typeof document.querySelectorAll === 'undefined',
    ltIE8: typeof addEventListener === 'undefined' && typeof document.getElementsByClassName === 'undefined',
    ie: !!document.uniqueID,
    firefox: !!window.globalStorage,
    opera: !!opera,
    webkit: !document.uniqueID && !opera && !window.globalStorage && !!localStorage,
...
$(function () {
   ...
   * カラーボックス
   */
  if ($.fn.colorbox) $('a[rel="colorbox"]').colorbox({maxWidth: '60%'})

  /**
   * ポップアップ
   */
  if ($.fn.colorbox) $('a[rel="popup"]').colorbox({width: '60%', height: '70%', iframe: true})
   ...
   * カラーボックス
   */
  if ($.fn.colorbox) $('a[rel="colorbox"]').colorbox({opacity: 0.8})
  if ($.fn.colorbox) $('a[rel="popup"]').colorbox({width: '60%', height: '70%', iframe: true})
 ...
 * 引き数なしの場合は、非表示にする
 *
 * TODO: グローバル汚染 users/edit.js で使用中
 *
