...
$(function () {
  ...
  $('#BtnPreview').click(function () {
    ...
    form.attr('action', fullUrl + '?preview=' + previewMode)
    form.submit()
              ...
              $.bcToken.check(function () {
                $.ajax({
                  ...
                  success: function (result) {
                    ...
                    location.href = $.baseUrl + '/admin/contents/edit_alias/' + result.id
                  },
  ...
  /**
   * TODO: functions.js で定義されているグローバル汚染関数 getNowDate / getNowTime を使用
   */
