	...
	<div id="BlogComment">
		...
		<table cellpadding="0" cellspacing="0" class="row-table-01">
			<tr>
				...
				<td><?php echo $this->BcForm->input('BlogComment.name', ['type' => 'text', 'size' => 12]) ?></td>
			</tr>
			<tr>
				<th><?php echo $this->BcForm->label('BlogComment.email', 'Eメール') ?></th>
				<td>
					<?php echo $this->BcForm->input('BlogComment.email', ['type' => 'text', 'size' => 12]) ?>&nbsp;
					<br><small>※ メールは公開されません</small>
				</td>
			</tr>
			<tr>
				<th><?php echo $this->BcForm->label('BlogComment.url', 'URL') ?></th>
				<td><?php echo $this->BcForm->input('BlogComment.url', ['type' => 'text', 'size' => 12]) ?></td>
			</tr>
			<tr>
				<th><?php echo $this->BcForm->label('BlogComment.message', 'コメント') ?></th>
				<td><?php echo $this->BcForm->input('BlogComment.message', ['type' => 'textarea', 'rows' => 8, 'cols' => 30]) ?></td>
			</tr>
		</table>
