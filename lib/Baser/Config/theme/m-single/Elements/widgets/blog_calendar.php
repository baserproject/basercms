 ...
 * @package			Baser.Plugin.Blog.View
...
<aside class="blogWidgetCalender widget-blog-calendar-<?php echo $id ?> blogWidget">
...
//カレンダーを表示するHTML
	print '<table class="blogCalendar"><tr><td colspan=7>';
	//print "<center>";
	if ($data['prev']) {
