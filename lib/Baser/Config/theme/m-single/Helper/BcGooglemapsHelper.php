 ...
 */
	public function load($address = '', $width = null, $height = null) {
		...
		if ($script) {
			if ($width || $height) {
				echo '<div id="' . $this->mapId . '" style="width: ' . $width . 'px; height:' . $height . 'px"><noscript>※javascriptを有効にしてください。</noscript></div>';
			} else {
				echo '<div id="' . $this->mapId . '"><noscript>※javascriptを有効にしてください。</noscript></div>';
			}
