		...
		<div id="CommentForm">
			...
			<table cellpadding="0" cellspacing="0" class="row-table-01">
				...
				<tr>
					...
					<td><?php echo $this->BcForm->input('BlogComment.name', ['type' => 'text', 'class' => 'form-m']) ?></td>
				</tr>
				<tr>
					<th><?php echo $this->BcForm->label('BlogComment.email', 'Eメール') ?><span style="color:red">＊</span></th>
					<td>
						<?php echo $this->BcForm->input('BlogComment.email', ['type' => 'text', 'size' => 30, 'class' => 'form-m']) ?><br>
						<small>※ メールは公開されません</small>
					</td>
				</tr>
				<tr>
					<th><?php echo $this->BcForm->label('BlogComment.url', 'URL') ?></th>
					<td><?php echo $this->BcForm->input('BlogComment.url', ['type' => 'text', 'size' => 30, 'class' => 'form-l']) ?></td>
				</tr>
				<tr>
					<th><?php echo $this->BcForm->label('BlogComment.message', 'コメント') ?><span style="color:red">＊</span></th>
					<td><?php echo $this->BcForm->input('BlogComment.message', ['type' => 'textarea', 'rows' => 10, 'cols' => 52, 'class' => 'form-l']) ?></td>
				</tr>
				</tbody>
			</table>
			...
			<?php echo $this->BcForm->end(['label' => '送信する', 'id' => 'BlogCommentAddButton', 'class' => 'button']) ?>
