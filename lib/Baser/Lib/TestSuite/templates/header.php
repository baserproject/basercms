...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style type="text/css">
			...
			ul.tests li.skipped,
			ul.tests li.fail {
				background: #fff2f2 url(<?php echo $baseDir; ?>themed/baseradmin/img/test-fail-icon.png) 5px 5px no-repeat;
			...
			ul.tests li.pass {
				...
				background-image: url(<?php echo $baseDir; ?>themed/baseradmin/img/test-pass-icon.png);
				border-color:green;
			}
			ul.tests li.skipped {
