...
<?php $this->BcBaser->js('/feed/ajax/' . $this->request->data['FeedConfig']['id']) ?>
	...
	<h4>jQueryの読み込み例</h4>
	<textarea cols="100" rows="2" onclick="this.select(0,this.value.length)" readonly="readonly"><?php echo $this->BcHtml->script('admin/vendors/jquery-2.1.4.min', ['once' => false]) ?></textarea>
</div>
<?php endif ?>
