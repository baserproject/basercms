...
<?php if($datas): ?>
    ...
    <?php foreach($datas as $data): ?>
        <tr>
            <td>
                <?php echo $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_check.png', array('alt' => '編集', 'class' => 'btn')), $data['MultiBlogContent']['Content']['url'] . '/view/' . $data['MultiBlogPost']['no'], array('target' => '_blank')) ?>
