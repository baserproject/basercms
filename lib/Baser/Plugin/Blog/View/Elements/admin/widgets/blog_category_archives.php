...
<?php echo $this->BcForm->text($key.'.limit', array('size' => 6)) ?>&nbsp;件<br />
...
<?php echo $this->BcForm->checkbox($key.'.by_year', array('label' => '年別に表示する')) ?><br />
<p id="Span<?php echo $key ?>Depth"><?php echo $this->BcForm->label($key.'.depth', '深さ') ?>&nbsp;
<?php echo $this->BcForm->text($key.'.depth', array('size' => 6, 'default' => 1)) ?>&nbsp;階層</p>
