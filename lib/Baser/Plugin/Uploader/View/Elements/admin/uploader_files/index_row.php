...
<?php if(!$listId): ?>
	<td class="row-tools" style="width:15%">
		<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_edit.png', ['alt' => '編集', 'class' => 'btn']), ['action' => 'edit', $file['UploaderFile']['id']], ['title' => '編集']) ?>
		<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_delete.png', ['alt' => '削除', 'class' => 'btn']), ['action' => 'delete', $file['UploaderFile']['id']], ['title' => '削除', 'class' => 'btn-delete']) ?>
	</td>
<?php endif ?>
	<td class="id">
	...
	<td class="img"><?php echo $this->Uploader->file($file,['size'=>'small','alt'=>$file['UploaderFile']['alt'],'style'=>'width:80px']) ?></td>
