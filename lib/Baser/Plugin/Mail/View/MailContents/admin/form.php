...
<div class="section">
	...
	<?php endif; ?>
		...
		<tr>
			...
			<td class="col-input">
				<?php echo $this->BcForm->ckeditor('MailContent.description', null, array('width' => 'auto', 'height' => '120px', 'type' => 'simple')) ?>
		...
		<tr>
			...
			<td class="col-input">
				<?php echo $this->BcForm->input('MailContent.sender_1_', array(
						'type'		=> 'radio',
...
<?php else: ?>
	<?php echo $this->BcForm->submit('更　新', array('div' => false, 'class' => 'btn-orange button')) ?>
