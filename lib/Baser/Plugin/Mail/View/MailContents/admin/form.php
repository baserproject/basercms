		...
		<tr>
			...
			<td class="col-input">
				...
				echo $this->BcForm->input('MailContent.sender_1_', [
					'type' => 'radio',
					'options' => ['0' => '管理者用メールアドレスに送信する', '1' => '別のメールアドレスに送信する'],
					'legend' => false,
					'separator' => '<br />'])
				?><br />
<?php echo $this->BcForm->input('MailContent.sender_1', ['type' => 'text', 'size' => 40, 'maxlength' => 255]) ?>
...
<?php echo $this->Html->image('admin/icn_help.png', ['id' => 'helpSenderName', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
<?php echo $this->BcForm->error('MailContent.sender_name') ?>
		...
		<tr>
			...
			<td class="col-input">
<?php echo $this->BcForm->input('MailContent.subject_user', ['type' => 'text', 'size' => 80]) ?>
<?php echo $this->Html->image('admin/icn_help.png', ['id' => 'helpSubjectUser', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
<?php echo $this->BcForm->error('MailContent.subject_user') ?>
		...
		<tr>
			...
			<td class="col-input">
<?php echo $this->BcForm->input('MailContent.subject_admin', ['type' => 'text', 'size' => 80]) ?>
<?php echo $this->Html->image('admin/icn_help.png', ['id' => 'helpSubjectAdmin', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
...
<?php echo $this->Html->image('admin/icn_help.png', ['id' => 'helpRedirectUrl', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
...
<div class="section">
	<table cellpadding="0" cellspacing="0" class="form-table slide-body" id="formOptionBody">
		<tr>
			...
			<td class="col-input">
				&nbsp;&nbsp;
				<?php echo $this->BcForm->dateTimePicker('MailContent.publish_begin', ['size' => 12, 'maxlength' => 10], true) ?>
				&nbsp;〜&nbsp;
				<?php echo $this->BcForm->dateTimePicker('MailContent.publish_end', ['size' => 12, 'maxlength' => 10], true) ?>
		...
		<tr>
			...
			<td class="col-input">
				<?php echo $this->BcForm->input('MailContent.save_info', ['type' => 'radio', 'options' => [1 => '送信情報をデータベースに保存する', 0 => '送信情報をデータベースに保存しない']]) ?>
				<?php echo $this->Html->image('admin/icn_help.png', ['id' => 'saveInfo', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
		...
		<tr>
			...
			<td class="col-input">
<?php echo $this->BcForm->input('MailContent.auth_captcha', ['type' => 'checkbox', 'label' => '利用する']) ?>
...
<?php echo $this->BcForm->error('MailContent.auth_captcha') ?>
		...
		<tr>
			...
			<td class="col-input">
<?php echo $this->BcForm->input('MailContent.ssl_on', ['type' => 'checkbox', 'label' => '利用する']) ?>
<?php echo $this->Html->image('admin/icn_help.png', ['id' => 'helpSslOn', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
<?php echo $this->BcForm->error('MailContent.ssl_on', 'SSL通信を利用するには、' . $this->BcBaser->getLink('システム設定', ['controller' => 'site_configs', 'action' => 'form', 'plugin' => null], ['target' => '_blank']) . 'で、
						事前にSSL通信用のWebサイトURLを指定してください。', ['escape' => false])
?>
...
<?php echo $this->Html->image('admin/icn_help.png', ['id' => 'helpSender2', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
<?php echo $this->BcForm->error('MailContent.sender_2') ?>
		...
		<tr>
			...
			<td class="col-input">
<?php echo $this->BcForm->input('MailContent.widget_area', ['type' => 'select', 'options' => $this->BcForm->getControlsource('WidgetArea.id'), 'empty' => 'サイト基本設定に従う']) ?>
...
<?php if ($this->action == 'admin_edit'): ?>
	&nbsp;<?php $this->BcBaser->link('編集する', 'javascript:void(0)', ['id' => 'EditForm', 'class' => 'button-small']) ?>&nbsp;
<?php endif ?>
<?php echo $this->Html->image('admin/icn_help.png', ['id' => 'helpFormTemplate', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
...
<?php if ($this->action == 'admin_edit'): ?>
	&nbsp;<?php $this->BcBaser->link('編集する', 'javascript:void(0)', ['id' => 'EditMail', 'class' => 'button-small']) ?>&nbsp;
<?php endif ?>
<?php echo $this->Html->image('admin/icn_help.png', ['id' => 'helpMailTemplate', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
