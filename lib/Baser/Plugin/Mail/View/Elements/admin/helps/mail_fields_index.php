...
<ul>
	<li><?php echo sprintf(__d('baser', '表左上の「並び替え」をクリックすると、各フィールドの操作欄に表示される%sマークをドラッグアンドドロップして公開ページでの並び順を変更する事ができます。'), $this->BcBaser->img('admin/sort.png', array('alt' => __d('baser', '並び替え'))))?></li>
