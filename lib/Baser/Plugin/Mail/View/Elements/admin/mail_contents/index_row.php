...
<tr <?php echo $class; ?>>
	<td class="row-tools">
		...
		<?php $this->BcBaser->link($this->BcBaser->getImg('admin/icn_tool_check.png', array('width' => 24, 'height' => 24, 'alt' => '確認', 'class' => 'btn')), '/' . $data['Content']['name'] . '/index', array('title' => '確認', 'target' => '_blank')) ?>
