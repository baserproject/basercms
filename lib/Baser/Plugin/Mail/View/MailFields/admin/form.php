...
<?php endif; ?>
		<tr id="RowFieldName">
			...
			<td class="col-input">
				...
				<?php echo $this->BcHtml->image('admin/icn_help.png', ['id' => 'helpFieldName', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
		...
		<tr id="RowType">
			...
			<td class="col-input">
				...
				<?php echo $this->BcHtml->image('admin/icn_help.png', ['id' => 'helpType', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
		...
		<tr id="RowHead">
			...
			<td class="col-input">
				...
				<?php echo $this->BcHtml->image('admin/icn_help.png', ['id' => 'helpHead', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
		...
		<tr id="RowNotEmpty">
			...
			<td class="col-input">
				<?php echo $this->BcForm->input('MailField.not_empty', ['type' => 'checkbox', 'label' => '項目見出しに必須マークを表示する']) ?>
		...
		<tr id="RowValid">
			...
			<td class="col-input">
				<?php echo $this->BcForm->input('MailField.valid', ['type' => 'select', 'options' => $this->BcForm->getControlSource('valid'), 'empty' => 'なし']) ?>
		...
		<tr id="RowSource">
			...
			<td class="col-input">
				...
				<?php echo $this->BcHtml->image('admin/icn_help.png', ['id' => 'helpSource', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
		...
		<tr id="RowRows">
			...
			<td class="col-input">
				...
				<?php echo $this->BcHtml->image('admin/icn_help.png', ['id' => 'helpRows', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
		...
		<tr id="RowMaxlength">
			...
			<td class="col-input">
				<?php echo $this->BcForm->input('MailField.maxlength', ['type' => 'text', 'size' => 10, 'maxlength' => 255]) ?>文字
	...
	<table cellpadding="0" cellspacing="0" class="form-table slide-body" id="formOptionBody">
		<tr id="RowValidEx">
			...
			<td class="col-input">
				...
				<?php echo $this->BcHtml->image('admin/icn_help.png', ['id' => 'helpValidEx', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
		...
		<tr id="RowGroupField">
			...
			<td class="col-input">
				...
				<?php echo $this->BcHtml->image('admin/icn_help.png', ['id' => 'helpGroupField', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
		...
		<tr id="RowGroupValid">
			...
			<td class="col-input">
				...
				<?php echo $this->BcHtml->image('admin/icn_help.png', ['id' => 'helpGroupValid', 'class' => 'btn help', 'alt' => 'ヘルプ']) ?>
		...
		<tr id="RowAutoConvert">
			...
			<td class="col-input">
				<?php echo $this->BcForm->input('MailField.auto_convert', ['type' => 'select', 'options' => $this->BcForm->getControlSource('auto_convert'), 'empty' => 'なし']) ?>
		...
		<tr id="RowUseField">
			...
			<td class="col-input">
				<?php echo $this->BcForm->input('MailField.use_field', ['type' => 'checkbox', 'label' => '利用中']) ?>
		...
		<tr id="RowNoSend">
			...
			<td class="col-input">
				<?php echo $this->BcForm->input('MailField.no_send', ['type' => 'radio', 'options' => ['送信する', '送信しない']]) ?>
...
<?php if ($this->action == 'admin_edit'): ?>
	<?php $this->BcBaser->link('削除', ['action' => 'delete', $mailContent['MailContent']['id'], $this->BcForm->value('MailField.id')], ['class' => 'submit-token button'], sprintf('%s を本当に削除してもいいですか？', $this->BcForm->value('MailField.name')), false); ?>
<?php endif ?>
</div>
