...
<!-- button -->
<p class="submit">
<?php $this->BcBaser->link('削除', ['action' => 'delete', $mailContent['MailContent']['id'], $message['MailMessage']['id']], ['class' => 'submit-token btn-gray button'], sprintf('受信メール NO「%s」を削除してもいいですか？', $message['MailMessage']['id']), false); ?>
</p>
