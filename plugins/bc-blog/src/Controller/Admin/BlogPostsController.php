...
class BlogPostsController extends BlogAppController
{
            ...
            $joins = [
                ...
                [
                    ...
                    'conditions' => [
                        ...
                        'BlogTag.id' => $this->request->data['BlogPost']['blog_tag_id']
                    ]
                ]
            ];
        }
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if ($event !== false) {
                if ($event->result === true) {
                    $this->request->data = $event->data['data'];
                } else {
            ...
            $this->request->data = $this->BlogPost->getDefaultValue(
                $this->BcAuth->user()
            );
        }
    ...
    public function admin_edit($blogContentId, $id)
    {
        ...
        if ($this->request->is(['post', 'put'])) {
            ...
            if (!BcUtil::isAdminUser()) {
                $this->request->data['BlogPost']['user_id'] = $this->BlogPost->field(
                    'user_id',
                    [
                        'BlogPost.id' => $id,
