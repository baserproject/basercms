...
//        $this->validate = [
//            'name' => [
//                ['rule' => ['notBlank'], 'message' => __d('baser_core', 'お名前を入力してください。')],
//                ['rule' => ['maxLength', 50], 'message' => __d('baser_core', 'お名前は50文字以内で入力してください。')]
//            ],
//            'email' => [
//                'email' => ['rule' => ['email'], 'message' => __d('baser_core', 'Eメールの形式が不正です。'), 'allowEmpty' => true],
//                'maxLength' => ['rule' => ['maxLength', 255], 'message' => __d('baser_core', 'Eメールは255文字以内で入力してください。')]
//            ],
//            'url' => [
//                'url' => ['rule' => ['url'], 'message' => __d('baser_core', 'URLの形式が不正です。'), 'allowEmpty' => true],
//                'maxLength' => ['rule' => ['maxLength', 255], 'message' => __d('baser_core', 'URLは255文字以内で入力してください。')]
//            ],
//            'message' => [
//                ['rule' => ['notBlank'], 'message' => __d('baser_core', 'コメントを入力してください。')]
//            ]
//        ];
//    }
