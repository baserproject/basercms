...
<tr<?php $this->BcListTable->rowClass($this->Blog->allowPublish($data), $data) ?>>
  ...
  <td class="row-tools bca-table-listup__tbody-td bca-table-listup__tbody-td--actions"><?php // アクション ?>
    ...
    <?php $this->BcBaser->link('', $this->request->getParam('Content.url') . '/archives/' . $data['BlogPost']['no'], ['title' => __d('baser', '確認'), 'target' => '_blank', 'class' => 'bca-btn-icon', 'data-bca-btn-type' => 'preview', 'data-bca-btn-size' => 'lg']) ?>
