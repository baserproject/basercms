...
class BlogBaserHelperTest extends BaserTestCase
{
     ...
     * $this->markTestIncomplete('このメソッドは、BlogHelper::posts() をラッピングしているメソッドのためスキップします。');
     * }
     */
     ...
     * $this->markTestIncomplete('このメソッドは、BlogHelper::getContents() をラッピングしているメソッドのためスキップします。');
     * }
     */
     ...
     * ブログのカテゴリ取得
     *
     * BlogHelper::getCategories() のラッピングのため、呼び出せるかどうかだけテストし、
     ...
     * ブログの子カテゴリを持っているかどうか
     *
     * BlogHelper::hasChildCategory() のラッピングのため、テストはスルー
     *
     * public function testHasChildBlogCategory() {
     * $this->markTestIncomplete('このメソッドは、BlogHelper::hasChildCategory() をラッピングしているメソッドのためスキップします。');
     * }
     */
     ...
     * $this->markTestIncomplete('このメソッドは、BlogHelper::getBlogTagList() をラッピングしているメソッドのためスキップします。');
     * }
     */
     ...
     * $this->markTestIncomplete('このメソッドは、BlogHelper::BlogTagList() をラッピングしているメソッドのためスキップします。');
     * }
     */
}
