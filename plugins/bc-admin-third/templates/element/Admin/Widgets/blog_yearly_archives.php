...
<?php echo $this->BcAdminForm->control($key . '.limit', ['type' => 'text', 'size' => 6, 'default' => null]) ?>&nbsp;件<br/>
...
<?php echo $this->BcAdminForm->control($key . '.start_month', ['type' => 'int', 'size' => 2, 'default' => 1]) ?>&nbsp;月<br/>
