...
$this->BcBaser->i18nScript([
  'confirmMessage1' => __d('baser_core', '
  ...
  '),
  'confirmTitle1' => __d('baser_core', '初期データ読込'),
], ['escape' => false]);
$this->BcBaser->js([
  'admin/themes/index.bundle'
]);
$this->BcAdmin->setTitle(__d('baser_core', 'テーマ一覧'));
...
<div id="tabs">
  <ul>
    <li><a href="#DataList"><?php echo __d('baser_core', '所有テーマ') ?></a></li>
