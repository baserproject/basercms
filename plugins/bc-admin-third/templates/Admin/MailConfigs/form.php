 ...
 * [ADMIN] メール設定 フォーム
 */
$this->BcBaser->js('BcMail.admin/mail_configs/form', false);
?>
<!-- form -->
...
<div class="section">
  <table id="FormTable" class="form-table bca-form-table">
    <tr>
      <th
        class="bca-form-table__label"><?php echo $this->BcForm->label('MailConfig.site_name', __d('baser', '署名：Webサイト名')) ?></th>
    ...
    <tr>
      <th
        class="bca-form-table__label"><?php echo $this->BcForm->label('MailConfig.site_url', __d('baser', '署名：WebサイトURL')) ?></th>
      <td class="col-input bca-form-table__input">
    ...
    <tr>
      <th
        class="bca-form-table__label"><?php echo $this->BcForm->label('MailConfig.site_email', __d('baser', '署名：Eメール')) ?></th>
      <td class="col-input bca-form-table__input">
    ...
    <tr>
      <th
        class="bca-form-table__label"><?php echo $this->BcForm->label('MailConfig.site_tel', __d('baser', '署名：電話番号')) ?></th>
      <td class="col-input bca-form-table__input">
    ...
    <tr>
      <th
        class="bca-form-table__label"><?php echo $this->BcForm->label('MailConfig.site_fax', __d('baser', '署名：FAX番号')) ?></th>
      <td class="col-input bca-form-table__input">
