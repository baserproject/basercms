...
<tr>
  <td class="row-tools bca-table-listup__tbody-td">
    <?php if ($this->BcBaser->isAdminUser()): ?>
      <?php echo $this->BcAdminForm->control('ListTool.batch_targets.' . $data['WidgetArea']['id'], ['type' => 'checkbox', 'label' => '<span class="bca-visually-hidden">' . __d('baser', 'チェックする') . '</span>', 'class' => 'batch-targets bca-checkbox__input', 'value' => $data['WidgetArea']['id']]) ?>
    <?php endif ?>
  </td>
  <td class="bca-table-listup__tbody-td"><?php echo $data['WidgetArea']['id']; ?></td>
  <td
    class="bca-table-listup__tbody-td"><?php $this->BcBaser->link($data['WidgetArea']['name'], ['action' => 'edit', $data['WidgetArea']['id']], ['escape' => true]); ?></td>
  <td class="bca-table-listup__tbody-td"><?php echo $data['WidgetArea']['count']; ?></td>
  <?php echo $this->BcListTable->dispatchShowRow($data) ?>
  <td
    class="bca-table-listup__tbody-td"><?php echo $this->BcTime->format($data['WidgetArea']['created'], 'yyyy-MM-dd'); ?>
    <br>
