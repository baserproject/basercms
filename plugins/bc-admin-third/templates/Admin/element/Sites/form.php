...
<table class="form-table bca-form-table">
	...
	<tr>
		...
		<td class="bca-form-table__input"><?php echo $this->BcAdminForm->control('Site.keyword', ['type' => 'text', 'size' => 55, 'maxlength' => 255, 'counter' => true, 'class' => 'bca-textbox__input full-width']) ?>
			<i class="bca-icon--question-circle btn help bca-help"></i>
	...
	<tr>
		...
		<td class="bca-form-table__input"><?php echo $this->BcAdminForm->control('Site.description', ['type' => 'textarea', 'cols' => 20, 'rows' => 6, 'maxlength' => 255, 'counter' => true]) ?>
			<i class="bca-icon--question-circle btn help bca-help"></i>
