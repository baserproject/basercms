...
<table class="form-table bca-form-table">
  ...
  <tr>
    ...
    <td class=" bca-form-table__input">
      <?php echo $this->BcAdminForm->control('Site.name', ['type' => 'text', 'size' => '30', 'autofocus' => true]) ?>
      ...
      　<span
        style="white-space: nowrap;"><small>[<?php echo $this->BcForm->label('Site.alias', __d('baser', 'エイリアス')) ?>]</small>
			<?php echo $this->BcAdminForm->control('Site.alias', ['type' => 'text', 'size' => '10']) ?></span>
      <i class="bca-icon--question-circle btn help bca-help"></i>
      <div
  ...
  <tr>
    <th class="bca-form-table__label"><?php echo $this->BcForm->label('Site.display_name', __d('baser', 'サイト名')) ?>
      &nbsp;<span class="bca-label" data-bca-label-type="required"><?php echo __d('baser', '必須') ?></span></th>
    <td class=" bca-form-table__input">
      <?php echo $this->BcAdminForm->control('Site.display_name', ['type' => 'text', 'size' => '60']) ?>
      <i class="bca-icon--question-circle btn help bca-help"></i>
      <div
  ...
  <tr>
    <th class="bca-form-table__label"><?php echo $this->BcForm->label('Site.title', __d('baser', 'サイトタイトル')) ?>
      &nbsp;<span class="bca-label" data-bca-label-type="required"><?php echo __d('baser', '必須') ?></span></th>
    <td class="bca-form-table__input">
      <?php echo $this->BcAdminForm->control('Site.title', ['type' => 'text', 'size' => '60']) ?>
      <i class="bca-icon--question-circle btn help bca-help"></i>
  ...
  <tr>
    <th
      class="bca-form-table__label"><?php echo $this->BcForm->label('Site.keyword', __d('baser', 'サイト基本キーワード')) ?></th>
    <td
      class="bca-form-table__input"><?php echo $this->BcAdminForm->control('Site.keyword', ['type' => 'text', 'size' => 55, 'maxlength' => 255, 'counter' => true, 'class' => 'bca-textbox__input full-width']) ?>
      <i class="bca-icon--question-circle btn help bca-help"></i>
  ...
  <tr>
    <th
      class="bca-form-table__label"><?php echo $this->BcForm->label('Site.description', __d('baser', 'サイト基本説明文')) ?></th>
    <td
      class="bca-form-table__input"><?php echo $this->BcAdminForm->control('Site.description', ['type' => 'textarea', 'cols' => 20, 'rows' => 6, 'maxlength' => 255, 'counter' => true]) ?>
      <i class="bca-icon--question-circle btn help bca-help"></i>
  ...
  <tr>
    <th
      class="bca-form-table__label"><?php echo $this->BcForm->label('Site.main_site_id', __d('baser', 'メインサイト')) ?></th>
    <td class=" bca-form-table__input">
      <?php echo $this->BcAdminForm->control('Site.main_site_id', ['type' => 'select', 'options' => $mainSites]) ?>
      <?php echo $this->BcAdminForm->control('Site.relate_main_site', ['type' => 'checkbox', 'label' => __d('baser', 'エイリアスを利用してメインサイトと自動連携する')]) ?>
      <i class="bca-icon--question-circle btn help bca-help"></i>
      <div class="helptext">
    ...
    <tr>
      ...
      <td class=" bca-form-table__input">
        <?php if ($useSiteDeviceSetting): ?>
          <small><?php echo __d('baser', '[デバイス]') ?></small>&nbsp;<?php echo $this->BcAdminForm->control('Site.device', ['type' => 'select', 'options' => $devices]) ?>
          <i class="bca-icon--question-circle btn help bca-help"></i>
          <div
            class="helptext"><?php echo __d('baser', 'サブサイトにデバイス属性を持たせ、サイトアクセス時、ユーザーエージェントを判定し適切なサイトを表示する機能を利用します。') ?></div>
        <?php else: ?>
          <?php echo $this->BcAdminForm->control('Site.device', ['type' => 'hidden']) ?>
        <?php endif ?>
        <?php if ($useSiteLangSetting): ?>
          <small><?php echo __d('baser', '[言語]') ?></small><?php echo $this->BcAdminForm->control('Site.lang', ['type' => 'select', 'options' => $langs]) ?>
          <i class="bca-icon--question-circle btn help bca-help"></i>
          <div
            class="helptext"><?php echo __d('baser', 'サブサイトに言語属性を持たせ、サイトアクセス時、ブラウザの言語設定を判定し適切なサイトを表示する機能を利用します。') ?></div>
        <?php else: ?>
          <?php echo $this->BcAdminForm->control('Site.lang', ['type' => 'hidden']) ?>
        <?php endif ?>
        <div id="SectionAccessType" style="display:none">
          <small><?php echo __d('baser', '[アクセス設定]') ?></small>
          <br>
          <span
            id="SpanSiteSameMainUrl"><?php echo $this->BcAdminForm->control('Site.same_main_url', ['type' => 'checkbox', 'label' => __d('baser', 'メインサイトと同一URLでアクセス')]) ?>&nbsp;
					<i class="bca-icon--question-circle btn help bca-help"></i>
					<div
          ...
          <br>
          <span
            id="SpanSiteAutoRedirect"><?php echo $this->BcAdminForm->control('Site.auto_redirect', ['type' => 'checkbox', 'label' => __d('baser', 'メインサイトから自動的にリダイレクト')]) ?>&nbsp;
					<i class="bca-icon--question-circle btn help bca-help"></i>
					<span
          ...
          <br>
          <span
            id="SpanSiteAutoLink"><?php echo $this->BcAdminForm->control('Site.auto_link', ['type' => 'checkbox', 'label' => __d('baser', '全てのリンクをサブサイト用に変換する')]) ?>&nbsp;
					<i class="bca-icon--question-circle btn help bca-help"></i>
					<span
  ...
  <tr>
    ...
    <td class=" bca-form-table__input">
      <?php echo $this->BcAdminForm->control('Site.theme', ['type' => 'select', 'options' => $themes]) ?>
      <i class="bca-icon--question-circle btn help bca-help"></i>
      <div
  ...
  <tr>
    ...
    <td class=" bca-form-table__input">
      <?php echo $this->BcAdminForm->control('Site.status', ['type' => 'radio', 'options' => [0 => __d('baser', '公開しない'), 1 => __d('baser', '公開する')]]) ?>
