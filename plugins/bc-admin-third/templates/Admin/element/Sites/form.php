...
<table class="form-table bca-form-table">
  ...
  <?php if(!$isMainOnCurrentDisplay): ?>
    <tr>
      <th class="bca-form-table__label"><?php echo $this->BcAdminForm->label('use_subdomain', __d('baser_core', 'ドメイン（サブドメイン）利用')) ?></th>
      <td class=" bca-form-table__input">
    ...
    <tr class="domain_type">
      ...
      <td class=" bca-form-table__input">
        <?php echo $this->BcAdminForm->control('domain_type', ['type' => 'radio', 'options' => [0 => __d('baser', '利用しない'), 1 => __d('baser', 'サブドメイン'), 2 => __d('baser', '別ドメイン')], 'default' => 0]) ?>
