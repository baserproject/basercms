  ...
  <section class="bca-section" data-bca-section-type="form-group">
    ...
    <div class="bca-collapse" id="pageSettingBody" data-bca-state="">
      <table class="form-table bca-form-table" data-bca-table-type="type2">
        <tr>
          <th
            class="bca-form-table__label"><?php echo $this->BcAdminForm->label('page_template', __d('baser', '固定ページテンプレート')) ?></th>
          <td class="col-input bca-form-table__input">
            <?php echo $this->BcAdminForm->control('page_template', ['type' => 'select', 'options' => $pageTemplateList]) ?>
            <div
              class="bca-helptext"><?php echo __d('baser', 'テーマフォルダ内の、templates/Page/ にテンプレートを配置する事で、ここでテンプレートを選択できます。') ?></div>
