 ...
 * @unitTest
 */
$title = __d('baser_core', '月別アーカイブ一覧');
$description = __d('baser_core', 'ブログの月別アーカイブー一覧を表示します。');
?>
...
<br>
<small>
  <?php echo __d('baser_core', 'ブログページを表示している場合は、上記の設定に関係なく、対象ブログの月別アーカイブ一覧を表示します。') ?>
</small>
