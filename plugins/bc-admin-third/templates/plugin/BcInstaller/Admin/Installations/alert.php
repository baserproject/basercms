...
<p
  class="bca-main__text"><?php echo __d('baser_core', 'インストールを開始するにはデバッグモードが {0} である必要があります。', '<code>-1</code>') ?></p>
...
<ol class="bca-main__number-list">
  ...
  <li><?php echo __d('baser_core', '{0} より次の行を見つけます。', 'install.php') ?>
    <pre>Configure::write('debug', 0);</pre>
  </li>
  <li><?php echo __d('baser_core', '{0} の部分を、 {1} に書き換えます。', '<code>0</code>', '<code>-1</code>') ?></li>
