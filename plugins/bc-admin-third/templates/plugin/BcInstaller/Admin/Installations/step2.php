...
<div class="step2">
  ...
  <div class="section bca-section">
    ...
    <div class="panel-box bca-panel-box corner10">
      ...
      <div class="section"><p
          class="bca-main__text"><?php echo __d('baser_core', 'PHPのメモリが {0} より低い場合、baserCMSの全ての機能が正常に動作しない可能性があります。', $requirePhpMemory . " MB") ?>
          <br>
      ...
      <ul class="section">
        <li class='<?php if ($phpMemoryOk) echo 'check';
          ...
          <?php echo __d('baser_core', 'PHPのメモリ上限 >= {0}', $requirePhpMemory . __d('baser_core', "MB")) ?>
          <div
            class="check-result"><?php echo __d('baser_core', '現在のPHPのメモリ上限： {0}', $phpMemory . __d('baser_core', "MB")) ?>
            <?php if (!$phpMemoryOk): ?>
              <br>
              <small><?php echo __d('baser_core', 'php.iniの設定変更が可能であれば、memory_limit の値を {0} 以上に設定してください', $requirePhpMemory . __d('baser_core', "MB")) ?></small>
            <?php endif ?>
          </div>
        </li>
      </ul>
