...
<ul>
  <li><?php echo __d('baser_core', '上層のフォルダへ移動するには、{0} をクリックします。（現在の位置がテーマフォルダの最上層の場合は表示されません）', '<i class="bca-btn-icon" data-bca-btn-type="up-directory"></i>') ?></li>
  ...
  <li><?php echo __d('baser_core', 'テーマファイルをコピーするには、対象ファイルの {0} をクリックします。', '<i class="bca-btn-icon" data-bca-btn-type="copy"></i>') ?></li>
  <li><?php echo __d('baser_core', 'テーマファイルを閲覧、編集する場合は、対象ファイルの {0} をクリックします。', '<i class="bca-btn-icon" data-bca-btn-type="edit"></i>') ?></li>
  <li><?php echo __d('baser_core', 'テーマファイルを削除するには、対象ファイルの {0} をクリックします。', '<i class="bca-btn-icon" data-bca-btn-type="delete"></i>') ?></li>
  <li><?php echo __d('baser_core', 'テーマファイルを現在のテーマにコピーするには、対象ファイル・フォルダの {0} をクリックし、その後表示される画面下の「現在のテーマにコピー」をクリックします。（core テーマのみ）', '<i class="bca-btn-icon" data-bca-btn-type="preview"></i>') ?></li>
</ul>
