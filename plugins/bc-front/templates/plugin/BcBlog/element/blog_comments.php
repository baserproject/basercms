...
<div class="bs-blog-comment">
	...
	<table class="bs-blog-comment__form">
		<tr>
			<th><?php echo $this->BcForm->label('BlogComment.name', __('お名前') . ' / ' . __('ニックネーム')) ?><span class="required"><?php echo __d('baser', '必須') ?></span></th>
			<td><?php echo $this->BcForm->input('BlogComment.name', ['type' => 'text', 'required' => false]) ?></td>
		</tr>
		<tr>
			<th><?php echo $this->BcForm->label('BlogComment.email', __('メールアドレス')) ?><span class="required"><?php echo __d('baser', '必須') ?></span></th>
			<td>
		...
		<tr>
			<th><?php echo $this->BcForm->label('BlogComment.url', 'URL') ?><span class="normal"><?php echo __d('baser', '任意') ?></span></th>
			<td><?php echo $this->BcForm->input('BlogComment.url', ['type' => 'text', 'size' => 30, 'required' => false]) ?></td>
		</tr>
		<tr>
			<th><?php echo $this->BcForm->label('BlogComment.message', __('コメント')) ?><span class="required"><?php echo __d('baser', '必須') ?></span></th>
