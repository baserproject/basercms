...
<tr id="RowMetaBcCcRelated" class="bca-row-meta">
    <th class="col-head bca-form-table__label">
        <?php echo $this->BcAdminForm->label('', __d('baser_core', '関連データ設定')) ?>
    </th>
    <td class="col-input bca-form-table__input">
        <?php echo $this->BcAdminForm->label('meta.BcCcRelated.custom_table_id', __d('baser_core', 'カスタムテーブル')) ?>&nbsp;&nbsp;
        ...
        <div class="bca-helptext">
          <?php echo __d('baser_core', 'データ元となるカスタムテーブルを指定します。') ?>
        </div>
        <br>
        <?php echo $this->BcAdminForm->label('meta.BcCcRelated.filter_name', __d('baser_core', '絞り込みフィールド')) ?>&nbsp;&nbsp;
