...
class PermissionsControllerTest extends BcTestCase
{
    ...
    {
        $this->post('/baser/api/admin/baser-core/permissions/index/1.json?token=' . $this->accessToken);
        $this->assertResponseCode(405);

        $this->get('/baser/api/admin/baser-core/permissions/index/2.json?token=' . $this->accessToken);
    ...
    public function testAdd()
    {
        ...
        $this->post('/baser/api/admin/baser-core/permissions/add.json?token=' . $this->accessToken, $data);
        $this->assertResponseSuccess();
    ...
    public function testEdit()
    {
        ...
        $this->post("/baser/api/admin/baser-core/permissions/edit/1.json?token=". $this->accessToken, $dataError);
    ...
    public function testDelete()
    {
        ...
        $this->post("/baser/api/admin/baser-core/permissions/delete/{$id}.json?token=" . $this->accessToken);
        $this->assertResponseSuccess();
        $result = json_decode((string)$this->_response->getBody());
        $this->assertEquals($result->permission->name, $data->name);
        $this->assertEquals('アクセスルール「test delete」を削除しました。', $result->message);

        $this->post("/baser/api/admin/baser-core/permissions/delete/2222.json?token=" . $this->accessToken);
    ...
    {
        $this->get('/baser/api/admin/baser-core/permissions/view/1.json?token=' . $this->accessToken);
    ...
    {
        $this->get('/baser/api/admin/baser-core/permissions/copy/1.json?token=' . $this->accessToken);
        $this->assertResponseCode(405);
    ...
    {
        $this->post('/baser/api/admin/baser-core/permissions/update_sort/2.json?token=' . $this->accessToken);
    ...
    public function testBatch()
    {
        ...
        // 空データ送信
        $this->post('/baser/api/admin/baser-core/permissions/batch.json?token=' . $this->accessToken, []);
        $this->assertResponseFailure();
        ...
        $this->post('/baser/api/admin/baser-core/permissions/batch.json?token=' . $this->accessToken, $data);
