...
//            'SearchIndexes'
    ...
    {
        $this->get('/baser/api/admin/baser-core/contents/view_trash/16.json?token=' . $this->accessToken);
    ...
    {
        // trashテスト
        $this->get('/baser/api/admin/baser-core/contents/index_trash.json?token=' . $this->accessToken);
        $this->assertResponseOk();
        $result = json_decode((string)$this->_response->getBody());
    ...
    public function testDelete()
    {
        // 子要素を持たない場合
        $data = ['id' => 4];
        $this->post('/baser/api/admin/baser-core/contents/delete.json?token=' . $this->accessToken, $data);
        $this->assertResponseOk();
        $result = json_decode((string)$this->_response->getBody());
        ...
        $this->post('/baser/api/admin/baser-core/contents/delete.json?token=' . $this->accessToken, $data);
        $this->assertResponseOk();
        $this->get('/baser/api/admin/baser-core/contents/view/6.json?token=' . $this->accessToken); // 親要素削除チェック
        $this->assertResponseError();
        $this->get('/baser/api/admin/baser-core/contents/view/11.json?token=' . $this->accessToken); // 子要素削除チェック
        $this->assertResponseError();
    }
    ...
    {
        $this->post('/baser/api/admin/baser-core/contents/trash_empty.json?type=ContentFolder&token=' . $this->accessToken);
        $this->assertResponseOk();
        $result = json_decode((string)$this->_response->getBody());
        $this->assertEquals("ゴミ箱を空にしました。", $result->message);
        $this->get('/baser/api/admin/baser-core/contents/index_trash.json?type=ContentFolder&token=' . $this->accessToken);
        $result = json_decode((string)$this->_response->getBody());
    ...
    public function testTrash_return()
    {
        ...
        $this->post("/baser/api/admin/baser-core/contents/trash_return/{$id}.json?token=" . $this->accessToken);
        $this->assertResponseOk();
    ...
    public function testChange_status_toUnpublish()
    {
        ...
        $this->patch("/baser/api/admin/baser-core/contents/change_status.json?token=" . $this->accessToken, $data);
        $this->assertResponseOk();
    ...
    {
        $this->get("/baser/api/admin/baser-core/contents/get_full_url/1.json?token=" . $this->accessToken);
        $this->assertResponseOk();
    ...
    {
        $this->get("/baser/api/admin/baser-core/contents/exists/1.json?token=" . $this->accessToken);
        $this->assertResponseOk();
        $this->assertTrue(json_decode($this->_response->getBody())->exists);
        $this->get("/baser/api/admin/baser-core/contents/exists/100.json?token=" . $this->accessToken);
        $this->assertResponseOk();
    ...
    public function testRename()
    {
        ...
        $this->patch("/baser/api/admin/baser-core/contents/rename.json?token=" . $this->accessToken);
        $this->assertResponseFailure();
        $data = ['id' => 6, 'title' => 'testRename'];
        $this->patch("/baser/api/admin/baser-core/contents/rename.json?token=" . $this->accessToken, $data);
        $this->assertResponseOk();
    ...
    public function testAdd_alias()
    {
        ...
        $this->post("/baser/api/admin/baser-core/contents/add_alias.json?token=" . $this->accessToken, $data);
        $this->assertResponseOk();
    ...
    {
        $this->get("/baser/api/admin/baser-core/contents/get_content_folder_list/1.json?token=" . $this->accessToken);
        $this->assertResponseOk();
    ...
    {
        $this->post("/baser/api/admin/baser-core/contents/is_unique_content.json?token=" . $this->accessToken);
        $this->assertResponseFailure();
        $this->post("/baser/api/admin/baser-core/contents/is_unique_content.json?token=" . $this->accessToken, ['url' => 'aaaa']);
        $this->assertTrue(json_decode($this->_response->getBody()));
        $this->post("/baser/api/admin/baser-core/contents/is_unique_content.json?token=" . $this->accessToken, ['url' => '/service/service2']);
    ...
    {
        // postDataがない場合
        $this->patch("/baser/api/admin/baser-core/contents/move.json?token=" . $this->accessToken);
        ...
        $this->patch("/baser/api/admin/baser-core/contents/move.json?token=" . $this->accessToken, $data);
    ...
    {
        // 空データ送信
        $this->post('/baser/api/admin/baser-core/contents/batch.json?token=' . $this->accessToken, []);
        $this->assertResponseFailure();
        // delete
        $data = [
            'batch' => 'delete',
        ...
        $this->post('/baser/api/admin/baser-core/contents/batch.json?token=' . $this->accessToken, $data);
        $this->assertResponseSuccess();
