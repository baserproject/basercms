...
class PagesControllerTest extends BcTestCase
{
    ...
    public function testAdd()
    {
        ...
        $this->post('/baser/api/admin/baser-core/pages/add.json?token=' . $this->accessToken, $data);
    ...
    {
        $this->delete('/baser/api/admin/baser-core/pages/delete/2.json?token=' . $this->accessToken);
    ...
    public function testEdit()
    {
        ...
        $id = $data->id;
        $this->post("/baser/api/admin/baser-core/pages/edit/{$id}.json?token=". $this->accessToken, $data->toArray());
        $this->assertResponseSuccess();
