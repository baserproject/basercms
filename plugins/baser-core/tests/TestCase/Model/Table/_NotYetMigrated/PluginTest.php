...
class PluginTest extends BaserTestCase
{
    ...
    {
        return [
            ['BcBlog', 1, 'ブログ管理', 'プラグイン管理のリンクを指定したユーザーのお気に入りに追加できません'],
            ['BcBlog', 2, 'ブログ管理', 'プラグイン管理のリンクを指定したユーザーのお気に入りに追加できません'],
            ['BcMail', 1, 'メールフォーム 管理', 'プラグイン管理のリンクを指定したユーザーのお気に入りに追加できません'],
        ];
    }
}
