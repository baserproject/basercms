...
');
    ...
    public function testConsole()
    {
        ...
        // check the command is added
        $this->assertTrue($result->has('setup test'));
        $this->assertTrue($result->has('composer'));
        $this->assertTrue($result->has('update'));
        $this->assertTrue($result->has('create release'));
        $this->assertTrue($result->has('setup install'));
