...
if (is_writable(ROOT . DS . 'bin' . DS . 'cake.php')) {
    ...
    BcUpdateLog::set(__d('baser_core', 'bin' . DS . 'cake.php に書き込み権限がありません。' . $updateDir . '内にあるファイルを利用して手動で上書きしてください。'));
}
if (is_writable(ROOT . DS . 'config' . DS . 'app.php')) {
    copy($updateDir . DS . 'config' . DS . 'app.php', ROOT . DS . 'config' . DS . 'app.php');
} else {
    BcUpdateLog::set(__d('baser_core', 'config' . DS . 'app.php に書き込み権限がありません。' . $updateDir . '内にあるファイルを利用して手動で上書きしてください。'));
}
if (is_writable(ROOT . DS . 'config' . DS . 'bootstrap.php')) {
    copy($updateDir . DS . 'config' . DS . 'bootstrap.php', ROOT . DS . 'config' . DS . 'bootstrap.php');
} else {
    BcUpdateLog::set(__d('baser_core', 'config' . DS . 'bootstrap.php に書き込み権限がありません。' . $updateDir . '内にあるファイルを利用して手動で上書きしてください。'));
}
if (is_writable(ROOT . DS . 'config' . DS . 'bootstrap_cli.php')) {
    ...
    BcUpdateLog::set(__d('baser_core', 'config' . DS . 'bootstrap_cli.php に書き込み権限がありません。' . $updateDir . '内にあるファイルを利用して手動で上書きしてください。'));
}
if (is_writable(ROOT . DS . 'src' . DS . 'Application.php')) {
    copy($updateDir . DS . 'src' . DS . 'Application.php', ROOT . DS . 'src' . DS . 'Application.php');
} else {
    BcUpdateLog::set(__d('baser_core', 'src' . DS . 'Application.php に書き込み権限がありません。' . $updateDir . '内にあるファイルを利用して手動で上書きしてください。'));
}
if (is_writable(ROOT . DS . 'src' . DS . 'Controller' . DS . 'AppController.php')) {
    ...
    BcUpdateLog::set(__d('baser_core', 'src' . DS . 'Controller' . DS . 'AppController.php に書き込み権限がありません。' . $updateDir . '内にあるファイルを利用して手動で上書きしてください。'));
}
if (is_writable(ROOT . DS . 'src' . DS . 'Controller' . DS . 'ErrorController.php')) {
    ...
    BcUpdateLog::set(__d('baser_core', 'src' . DS . 'Controller' . DS . 'ErrorController.php に書き込み権限がありません。' . $updateDir . '内にあるファイルを利用して手動で上書きしてください。'));
}
if (is_writable(ROOT . DS . 'src' . DS . 'View' . DS . 'AjaxView.php')) {
    ...
    BcUpdateLog::set(__d('baser_core', 'src' . DS . 'View' . DS . 'AjaxView.php に書き込み権限がありません。' . $updateDir . '内にあるファイルを利用して手動で上書きしてください。'));
}
if (is_writable(ROOT . DS . 'webroot' . DS . 'index.php')) {
    copy($updateDir . DS . 'webroot' . DS . 'index.php', ROOT . DS . 'webroot' . DS . 'index.php');
} else {
    BcUpdateLog::set(__d('baser_core', 'webroot' . DS . 'index.php に書き込み権限がありません。' . $updateDir . '内にあるファイルを利用して手動で上書きしてください。'));
}
if (is_writable(ROOT . DS . 'config' . DS . 'plugins.php')) {
    copy($updateDir . DS . 'config' . DS . 'plugins.php', ROOT . DS . 'config' . DS . 'plugins.php');
} else {
    BcUpdateLog::set(__d('baser_core', 'config' . DS . 'plugins.php に書き込み権限がありません。' . $updateDir . '内にあるファイルを利用して手動で上書きしてください。'));
}
