...
<div class="bs-blog-comment">
	...
	<?php echo $this->BcForm->control('BlogComment.captcha_id', [
		'type' => 'hidden',
		'value' => $captchaId
	]) ?>
	...
	<table class="bs-blog-comment__form">
		<tr>
			...
			<td><?php echo $this->BcForm->control('BlogComment.name', ['type' => 'text', 'required' => false]) ?></td>
		</tr>
		<tr>
			<th><?php echo $this->BcForm->label('BlogComment.email', __('メールアドレス')) ?><span class="required">必須</span></th>
			<td>
				<?php echo $this->BcForm->control('BlogComment.email', ['type' => 'text', 'size' => 30, 'required' => false]) ?>&nbsp;
				<br><small>※ <?php echo __('メールアドレスは公開されません') ?></small>
			</td>
		</tr>
		<tr>
			<th><?php echo $this->BcForm->label('BlogComment.url', 'URL') ?><span class="normal">任意</span></th>
			<td><?php echo $this->BcForm->control('BlogComment.url', ['type' => 'text', 'size' => 30, 'required' => false]) ?></td>
		</tr>
		<tr>
			<th><?php echo $this->BcForm->label('BlogComment.message', __('コメント')) ?><span class="required">必須</span></th>
			<td><?php echo $this->BcForm->control('BlogComment.message', ['type' => 'textarea', 'rows' => 10, 'cols' => 52, 'required' => false]) ?></td>
		</tr>
	</table>
