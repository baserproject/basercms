...
<div class="bs-widget bs-widget-search-box bs-widget-search-box-<?php echo $id ?>">
    ...
    <div class="bs-widget-form">
        ...
        <?php if ($folders): ?>
            ...
            <?php echo $this->BcForm->control('SearchIndex.f', ['type' => 'select', 'options' => $folders, 'empty' => __('指定しない')]) ?>
            <br>
        <?php endif ?>
        <?php echo $this->BcForm->control('SearchIndex.q', ['placeholder' => __('キーワード'), 'escape' => false]) ?>
