...
<div class="function-box corner10" id="BlogPostFilterBody" style="display:none">
    ...
    <p>
    <small>カテゴリ</small>
        <?php echo $formEx->select('BlogPost.blog_category_id',  $formEx->getControlSource('blog_category_id',array('blogContentId'=>$blogContent['BlogContent']['id'])),null,array('escape'=>false)) ?>　
    <small>公開設定</small>
        <?php echo $formEx->select('BlogPost.status', $textEx->booleanMarkList()) ?>　
    </p>
