...
<table cellpadding="0" cellspacing="0" class="admin-col-table-01" id="TableBlogContents">
	...
	<?php if(!empty($listDatas)): ?>
		...
		<?php foreach($listDatas as $listData): ?>
			...
			<?php endif; ?>
	<tr<?php echo $class; ?>>
		<td class="operation-button"><?php $baser->link('確認','/'.$listData['BlogContent']['name'],array('target'=>'_blank','class'=>'btn-green-s button-s')) ?>
