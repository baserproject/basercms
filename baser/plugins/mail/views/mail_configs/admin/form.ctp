...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01">
	<tr>
		...
		<td class="col-input"><?php echo $form->text('MailConfig.site_name', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpSiteName','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('MailConfig.site_url', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpSiteUrl','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('MailConfig.site_email', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpSiteEmail','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('MailConfig.site_tel', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpSiteTel','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('MailConfig.site_fax', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpSiteFax','class'=>'help','alt'=>'ヘルプ')) ?>
...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01 slide-body" id="formOptionBody">
	<tr>
		...
		<td class="col-input"><?php echo $form->text('MailConfig.encode', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpEncode','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('MailConfig.smtp_host', array('size'=>35,'maxlength'=>255)) ?> <?php echo $form->error('MailConfig.smtp_host') ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpSmtpHost','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('MailConfig.smtp_username', array('size'=>35,'maxlength'=>255)) ?> <?php echo $form->error('MailConfig.smtp_username') ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpSmtpUsername','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('MailConfig.smtp_password', array('size'=>35,'maxlength'=>255)) ?> <?php echo $form->error('MailConfig.smtp_password') ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpSmtpPassword','class'=>'help','alt'=>'ヘルプ')) ?>
