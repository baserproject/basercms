...
<div class="section">
	...
	<?php endif; ?>
		<tr>
			<th class="col-head"><?php echo $formEx->label('MailContent.name', 'メールフォームアカウント名') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
		...
		<tr>
			<th class="col-head"><?php echo $formEx->label('MailContent.title', 'メールフォームタイトル') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
		...
		<tr>
			...
			<td class="col-input">
				<?php echo $formEx->ckeditor('MailContent.description', null, array('width' => 'auto', 'height' => '120px', 'type' => 'simple')) ?>
				<?php echo $formEx->error('MailContent.description') ?>
			</td>
		</tr>
		<tr>
			<th class="col-head"><?php echo $formEx->label('MailContent.sender_1', '送信先メールアドレス') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
		...
		<tr>
			<th class="col-head"><?php echo $formEx->label('MailContent.sender_name', '送信先名') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
				<?php echo $formEx->input('MailContent.sender_name', array('type' => 'text', 'size' => 80, 'maxlength' => 255)) ?>
		...
		<tr>
			<th class="col-head"><?php echo $formEx->label('MailContent.subject_user', '自動返信メール<br />件名<br />[ユーザー宛]') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
				<?php echo $formEx->input('MailContent.subject_user', array('type' => 'text', 'size' => 80)) ?>
		...
		<tr>
			<th class="col-head"><?php echo $formEx->label('MailContent.subject_admin', '自動送信メール<br />件名<br />[管理者宛]') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
				<?php echo $formEx->input('MailContent.subject_admin', array('type' => 'text', 'size' => 80)) ?>
		...
		<tr>
			...
			<td class="col-input">
				<?php echo $formEx->input('MailContent.redirect_url', array('type' => 'text', 'size' => 80, 'maxlength' => 255)) ?>
		...
		<tr>
			<th class="col-head"><?php echo $formEx->label('MailContent.auth_capthca', 'イメージ認証') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
		...
		<tr>
			<th class="col-head"><?php echo $formEx->label('MailContent.ssl_on', 'SSL通信') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
