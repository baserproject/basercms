...
<?php echo $formEx->create('MailField', array('url' => array('controller' => 'mail_fields', 'action' => 'add', $mailContent['MailContent']['id']))) ?>
<?php elseif($this->action == 'admin_edit'): ?>
<?php echo $formEx->create('MailField', array('url' => array('controller' => 'mail_fields', 'action' => 'edit', $mailContent['MailContent']['id'], $formEx->value('MailField.id'), 'id' => false))) ?>
<?php endif; ?>
...
<div class="section">
	...
	<?php endif; ?>
		<tr id="rowFieldName">
			<th class="col-head"><?php echo $formEx->label('MailField.field_name', 'フィールド名') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
		...
		<tr id="rowName">
			<th class="col-head"><?php echo $formEx->label('MailField.name', '項目名') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
		...
		<tr id="rowType">
			<th class="col-head"><?php echo $formEx->label('MailField.type', 'タイプ') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
...
<div class="section">
	<table cellpadding="0" cellspacing="0" class="form-table slide-body" id="formOptionBody">
		...
		<tr id="rowUseField">
			<th class="col-head"><?php echo $formEx->label('MailField.use_field', '利用状態') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
		...
		<tr id="rowNoSend">
			<th class="col-head"><?php echo $formEx->label('MailField.no_send', 'メール送信') ?>&nbsp;<span class="required">*</span></th>
			<td class="col-input">
