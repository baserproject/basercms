...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01">
	...
	<tr>
		...
		<td class="col-input"><?php echo $formEx->text('MailField.no', array('size'=>20,'maxlength'=>255,'readonly'=>'readonly')) ?></td>
	</tr>
	<?php endif; ?>
	<tr id="rowFieldName">
		<th class="col-head"><span class="required">*</span>&nbsp;<?php echo $formEx->label('MailField.field_name', 'フィールド名') ?></th>
		<td class="col-input"><?php echo $formEx->text('MailField.field_name', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpFieldName','class'=>'help','alt'=>'ヘルプ')) ?>
			<div id="helptextFieldName" class="helptext">重複しない半角英数字で入力して下さい。</div>
			<?php echo $formEx->error('MailField.field_name') ?></td>
	</tr>
	<tr id="rowName">
		<th class="col-head"><span class="required">*</span>&nbsp;<?php echo $formEx->label('MailField.name', '項目名') ?></th>
		<td class="col-input"><?php echo $formEx->text('MailField.name', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpName','class'=>'help','alt'=>'ヘルプ')) ?>
			<div id="helptextName" class="helptext">項目を特定しやすいわかりやすい名前を入力して下さい。日本語可。</div>
			<?php echo $formEx->error('MailField.name') ?></td>
	</tr>
	<tr id="rowType">
		<th class="col-head"><span class="required">*</span>&nbsp;<?php echo $formEx->label('MailField.type', 'タイプ') ?></th>
		<td class="col-input"><?php echo $formEx->select('MailField.type', $controlSource['type']) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpType','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr id="rowHead">
		...
		<td class="col-input"><?php echo $formEx->text('MailField.head', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpHead','class'=>'help','alt'=>'ヘルプ')) ?>
			<div id="helptextHead" class="helptext"> グループの場合、２番目以降のフィールドは不要です。 </div>
			<?php echo $formEx->error('MailField.head') ?></td>
	</tr>
	<tr id="rowNotEmpty">
		<th class="col-head"><?php echo $formEx->label('MailField.not_empty', '必須マーク') ?></th>
		<td class="col-input"><?php echo $formEx->checkbox('MailField.not_empty', array('label'=>'項目見出しに必須マークを表示する')) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpNotEmpty','class'=>'help','alt'=>'ヘルプ')) ?>
			<div id="helptextNotEmpty" class="helptext">グループの場合、２番目以降のフィールドは不要です。</div>
			<?php echo $formEx->error('MailField.not_empty') ?></td>
	</tr>
	<tr id="rowValid">
	...
	<tr id="rowSource">
		...
		<td class="col-input"><?php echo $formEx->textarea('MailField.source',array('cols'=>35,'rows'=>4)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpSource','class'=>'help','alt'=>'ヘルプ')) ?>
			...
			<?php echo $formEx->error('MailField.source') ?></td>
	</tr>
	<tr id="rowSize">
	...
	<tr id="rowRows">
		...
		<td class="col-input"><?php echo $formEx->text('MailField.rows', array('size'=>10,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpRows','class'=>'help','alt'=>'ヘルプ')) ?>
			<div id="helptextRows" class="helptext">テキストボックスの場合の行数を指定します。</div>
			<?php echo $formEx->error('MailField.rows') ?></td>
	</tr>
	<tr id="rowMaxlength">
...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01 slide-body" id="formOptionBody">
	...
	<tr id="rowGroupField">
		...
		<td class="col-input"><?php echo $formEx->text('MailField.group_field', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpGroupField','class'=>'help','alt'=>'ヘルプ')) ?>
			...
			<?php echo $formEx->error('MailField.group_field') ?></td>
	</tr>
	<tr id="rowGroupValid">
		<th class="col-head"><?php echo $formEx->label('MailField.group_valid', 'グループ入力チェック') ?></th>
		<td class="col-input"><?php echo $formEx->text('MailField.group_valid', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpGroupValid','class'=>'help','alt'=>'ヘルプ')) ?>
			...
			<?php echo $formEx->error('MailField.group_valid') ?></td>
	</tr>
	<tr id="rowOptions">
	...
	<tr id="rowUseField">
		...
		<td class="col-input"><?php echo $formEx->radio('MailField.use_field', $textEx->booleanDoList("利用"),array("legend"=>false,"separator"=>"&nbsp;&nbsp;")) ?> <?php echo $formEx->error('MailField.use_field') ?>&nbsp; </td>
	</tr>
	<tr id="rowNoSend">
		<th class="col-head"><span class="required">*</span>&nbsp;<?php echo $formEx->label('MailField.no_send', 'メール送信') ?></th>
		<td class="col-input"><?php echo $formEx->radio('MailField.no_send', array(0=>'送信する',1=>'送信しない'),array("legend"=>false,"separator"=>"&nbsp;&nbsp;")) ?> <?php echo $formEx->error('MailField.no_send') ?>&nbsp; </td>
	</tr>
</table>
<div class="submit">
	<?php if($this->action == 'admin_add'): ?>
