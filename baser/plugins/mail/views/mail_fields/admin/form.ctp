...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01">
	...
	<tr id="rowFieldName">
		...
		<td class="col-input"><?php echo $formEx->text('MailField.field_name', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpFieldName','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr id="rowName">
		...
		<td class="col-input"><?php echo $formEx->text('MailField.name', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpName','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr id="rowHead">
		...
		<td class="col-input"><?php echo $formEx->text('MailField.head', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpHead','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr id="rowNotEmpty">
		...
		<td class="col-input"><?php echo $formEx->checkbox('MailField.not_empty', array('label'=>'項目見出しに必須マークを表示する')) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpNotEmpty','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr id="rowSource">
		...
		<td class="col-input"><?php echo $formEx->textarea('MailField.source',array('cols'=>35,'rows'=>4)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpSource','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr id="rowRows">
		...
		<td class="col-input"><?php echo $formEx->text('MailField.rows', array('size'=>10,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpRows','class'=>'help','alt'=>'ヘルプ')) ?>
...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01 slide-body" id="formOptionBody">
	...
	<tr id="rowGroupField">
		...
		<td class="col-input"><?php echo $formEx->text('MailField.group_field', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpGroupField','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr id="rowGroupValid">
		...
		<td class="col-input"><?php echo $formEx->text('MailField.group_valid', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpGroupValid','class'=>'help','alt'=>'ヘルプ')) ?>
