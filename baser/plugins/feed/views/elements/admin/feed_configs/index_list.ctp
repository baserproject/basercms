...
<?php endif ?>
			...
			<th><?php echo $paginator->sort(array('asc' => $baser->getImg('admin/blt_list_down.png', array('alt' => '昇順', 'title' => '昇順')).' フィード設定名', 'desc' => $baser->getImg('admin/blt_list_up.png', array('alt' => '降順', 'title' => '降順')).' フィード設定名'), 'name', array('escape' => false, 'class' => 'btn-direction')) ?></th>
			<th><?php echo $paginator->sort(array('asc' => $baser->getImg('admin/blt_list_down.png', array('alt' => '昇順', 'title' => '昇順')).' 表示件数', 'desc' => $baser->getImg('admin/blt_list_up.png', array('alt' => '降順', 'title' => '降順')).' 表示件数'), 'display_number', array('escape' => false, 'class' => 'btn-direction')) ?></th>
	...
	<?php if(!empty($feedConfigs)): ?>
		<?php foreach($feedConfigs as $data): ?>
			<?php $baser->element('feed_configs/index_row', array('data' => $data)) ?>
		<?php endforeach; ?>
	<?php else: ?>
		<tr>
