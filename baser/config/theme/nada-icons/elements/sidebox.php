...
?>
        ...
        <div id="Alfa" >
            ...
            <div id="sidebox">
                <div id="sidebox-bnr">
                    <?php $bcBaser->img('./sidebox/icons_banner_01.png', array('url' => '/#')); ?>
                </div>
                <div id="sidebox-bnr2">
                    <?php $bcBaser->img('./sidebox/icons_banner_02.png', array('url' => '/#')); ?>
                </div>
            </div>


            <div id="sidebox">
                <div id="sidebox-bnr3"><?php $bcBaser->img('./sidebox/sidebox_logo.png'); ?></div>
                <div id="sidebox-txt" class="sidebox-text">baserCMS</div>
                <div id="sidebox-bnr4">
                    <?php $bcBaser->link($bcBaser->getImg('./sidebox/sidebox_contact.png',array('title'=>'お問い合わせ','alt'=>'お問い合わせ')),'/contact') ;?>
                </div>
                <div id="sidebox-txt">
