...
INSERT INTO bc_site_configs (name, value, created, modified) VALUES
('maintenance', '',datetime('now', 'localtime'),datetime('now', 'localtime'));
INSERT INTO bc_site_configs (name, value, created, modified) VALUES
('widget_area', '1',datetime('now', 'localtime'),datetime('now', 'localtime'));
