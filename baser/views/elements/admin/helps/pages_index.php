...
<ul>
	...
	<li>公開状態を設定する事ができ、公開中のページを確認するには、一覧左側の「確認」ボタンをクリックします。</li>
	<li>各ページは分類分け用の「カテゴリ」に属させる事ができ、階層構造のURLを実現できます。</li>
	<li>管理画面内では、公開状態、カテゴリ等によりページの検索を行う事ができます。</li>
	<li>一覧左上の「並び替えモード」をクリックすると、各データの左に表示される<?php $bcBaser->img('sort.png',array('alt'=>'並び替え')) ?>マークをドラッグアンドドロップして、公開ページにおけるデータの表示順の変更を行う事ができます。<br />
