...
<ul>
	...
	<li>テーマファイルをコピーするには、対象ファイルの<?php $baser->img('admin/icn_tool_copy.png') ?>をクリックします。</li>
	<li>テーマファイルを閲覧、編集する場合は、対象ファイルの<?php $baser->img('admin/icn_tool_edit.png') ?>をクリックします。</li>
	<li>テーマファイルを削除するには、対象ファイルの<?php $baser->img('admin/icn_tool_delete.png') ?>をクリックします。</li>
	<li>テーマファイルを現在のテーマにコピーするには、対象ファイル・フォルダの<?php $baser->img('admin/icn_tool_view.png') ?>をクリックし、その後表示される画面下の「現在のテーマにコピー」をクリックします。（core テーマのみ）</li>
</ul>
