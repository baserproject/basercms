...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01">
	...
	<tr>
		...
		<td class="col-input"><?php echo $formEx->text('GlobalMenu.no', array('size'=>20,'maxlength'=>255,'readonly'=>'readonly')) ?>&nbsp; </td>
	</tr>
	<?php endif; ?>
	<tr>
		<th class="col-head"><span class="required">*</span>&nbsp;<?php echo $formEx->label('GlobalMenu.name', 'メニュー名') ?></th>
		<td class="col-input"><?php echo $formEx->text('GlobalMenu.name', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpName','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $formEx->text('GlobalMenu.link', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpLink','class'=>'help','alt'=>'ヘルプ')) ?>
			<div id="helptextLink" class="helptext"> 先頭にスラッシュつけたルートパスで入力して下さい。<br />
				(例) /admin/global/index </div>
			<?php echo $formEx->error('GlobalMenu.link') ?></td>
	</tr>
	<tr>
		<th class="col-head"><span class="required">*</span>&nbsp;<?php echo $formEx->label('GlobalMenu.status', '利用状態') ?></th>
		<td class="col-input"><?php echo $formEx->radio('GlobalMenu.status', $textEx->booleanDoList("利用"),array("legend"=>false,"separator"=>"&nbsp;&nbsp;")) ?> <?php echo $formEx->error('GlobalMenu.status') ?> &nbsp; </td>
	</tr>
</table>
<div class="submit">
