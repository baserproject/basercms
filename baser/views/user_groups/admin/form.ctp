...
<?php echo $form->create('UserGroup') ?> <?php echo $form->hidden('UserGroup.id') ?>
<table cellpadding="0" cellspacing="0" class="admin-row-table-01">
	<?php if($this->action == 'admin_edit'): ?>
	<tr>
		<th class="col-head"><?php echo $form->label('UserGroup.id', 'NO') ?></th>
		<td class="col-input"><?php echo $form->text('UserGroup.id', array('size'=>20,'maxlength'=>255,'readonly'=>'readonly')) ?>&nbsp; </td>
	</tr>
	<?php endif; ?>
	<tr>
