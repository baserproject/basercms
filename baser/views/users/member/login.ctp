...
<h2 class="contents-head">メンバーログイン</h2>
<div id="login">
<div class="box-01">
<div class="box-head">
<h3 class="contents-head">アカウント／パスワードを入力して下さい</h3>
</div>
<div class="box-body">
<?php echo $form->create('User',array('url'=>array('member'=>true,'action'=>'login'))) ?>
<table border="0">
...
<?php echo $form->end(array('label'=>'　ログインする　', 'div'=>false, 'class'=>'btn-orange button')) ?>
</p>
</div>
<div class="box-foot">
&nbsp;
