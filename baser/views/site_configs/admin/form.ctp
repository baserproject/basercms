...
<?php echo $form->create('SiteConfig',array('action'=>'form')) ?> <?php echo $form->hidden('SiteConfig.id') ?>
<table cellpadding="0" cellspacing="0" class="admin-row-table-01">
	<tr>
		<th class="col-head"><span class="required">*</span>&nbsp;<?php echo $form->label('SiteConfig.name', 'WEBサイト名') ?></th>
		<td class="col-input"><?php echo $form->text('SiteConfig.name', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpName','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.name') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('SiteConfig.keyword', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpKeyword','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.keyword') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->textarea('SiteConfig.description', array('cols'=>36,'rows'=>5,'style'=>'width:80%')) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpDescription','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.description') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('SiteConfig.email', array('size'=>35,'maxlength'=>255)) ?> <?php echo $form->error('SiteConfig.email') ?></td>
	</tr>
</table>
...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01 slide-body" id="formOptionBody">
	<tr>
		...
		<td class="col-input"><?php echo $form->text('SiteConfig.address', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpAddress','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.address') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('SiteConfig.googlemaps_key', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpGooglemapsKey','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.googlemaps_key') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('SiteConfig.twitter_username', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpTwitterUsername','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.twitter_username') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('SiteConfig.twitter_count', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpTwitterCount','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.twitter_count') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->select('SiteConfig.theme', $themes,null,null,'なし') ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpTheme','class'=>'help','alt'=>'ヘルプ')) ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->select('SiteConfig.mode', $formEx->getControlSource('mode'),null,null,false) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpDebug','class'=>'help','alt'=>'ヘルプ')) ?>
