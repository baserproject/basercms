...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01">
	<tr>
		...
		<td class="col-input"><?php echo $form->text('SiteConfig.name', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpName','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.name') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('SiteConfig.keyword', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpKeyword','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.keyword') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->textarea('SiteConfig.description', array('cols'=>36,'rows'=>5,'style'=>'width:80%')) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpDescription','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.description') ?>
...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01 slide-body" id="formOptionBody">
	<tr>
		...
		<td class="col-input"><?php echo $form->text('SiteConfig.address', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpAddress','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.address') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $form->text('SiteConfig.googlemaps_key', array('size'=>35,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.gif',array('id'=>'helpGooglemapsKey','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('SiteConfig.googlemaps_key') ?>
