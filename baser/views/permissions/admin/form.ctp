...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01">
	...
	<tr>
		...
		<td class="col-input"><?php echo $formEx->text('Permission.name', array('size'=>20,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpName','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('Permission.name') ?>
	...
	<tr>
		...
		<td class="col-input"><?php echo $formEx->text('Permission.url', array('size'=>40,'maxlength'=>255)) ?> <?php echo $html->image('img_icon_help_admin.png',array('id'=>'helpUrl','class'=>'help','alt'=>'ヘルプ')) ?> <?php echo $form->error('Permission.url') ?>
