...
<table cellpadding="0" cellspacing="0" class="admin-row-table-01">
	<tr>
		...
		<td class="col-input">
			<?php if($this->action != 'admin_view'): ?>
				<?php echo $formEx->text('ThemeFile.name', array('size'=>30,'maxlength'=>255)) ?>
				.<?php echo $formEx->value('ThemeFile.ext') ?><?php echo $formEx->hidden('ThemeFile.ext') ?>
			...
			<?php else: ?>
				<?php echo $formEx->text('ThemeFile.name', array('size'=>30,'readonly'=>'readonly')) ?>
				.<?php echo $formEx->value('ThemeFile.ext') ?><?php echo $formEx->hidden('ThemeFile.ext') ?>
			<?php endif ?>
        </td>
	</tr>
	<tr>
        ...
        <td class="col-input">
			...
			<?php else: ?>
				<?php if($this->action != 'admin_view'): ?>
					<?php echo $formEx->textarea('ThemeFile.contents',array('cols'=>80, 'rows'=>20)) ?>
