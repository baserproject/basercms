...
<div>
	...
	<div class="section"> インストールされたBaserCMSの設定ファイルを編集ができないように権限を755に変更して下さい。
		<ul>
			<li><?php echo str_replace($_SERVER['DOCUMENT_ROOT'],'',CONFIGS) ?></li>
		</ul>
	</div>
	<h4>.htaccess自動設定の為の権限変更を元に戻す</h4>
	<div class="section"> また、.htaccessの自動設定を利用する為に権限を変更した場合も権限の変更を推奨します。
		<ul>
