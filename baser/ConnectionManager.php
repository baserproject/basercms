 ...
 */
	function loadDataSource($connName) {
		...
		if (file_exists(APP . 'Model' . DS . 'datasources' . DS . $conn['filename'] . '.php')) {
			require (APP . 'Model' . DS . 'datasources' . DS . $conn['filename'] . '.php');
		...
		// <<<
		} elseif (fileExistsInPath(CAKE . 'model' . DS . 'datasources' . DS . $conn['filename'] . '.php')) {
			require (CAKE . 'model' . DS . 'datasources' . DS . $conn['filename'] . '.php');
		} else {
		    $error = __('Unable to load DataSource file %s.php');
