...
(7, 1, 8, 'メールアドレス確認', 'email_2', 'text', 'メールアドレス（確認）', '', '', '', '', NULL, NULL, 50, 'placeholder|確認のためもう一度入力して下さい', '', '', '', '', 'email', 'email', 'VALID_EMAIL', 'VALID_EMAIL_CONFIRM', '', 1, 1, 1, 7, '2016-08-12 00:48:34', '2020-09-14 19:42:37'),
